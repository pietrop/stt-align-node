...
describe('Equal - base text === STT output', () => {
  test('Equal - exactly same', () => {
    const baseTextAccurateTranscription =
      'There was a day about ten years ago when i asked a friend to hold a baby dinosaur robot upside down';
  ...
  test('Equal - but different punctuation and capitalization', () => {
    const baseTextAccurateTranscription =
