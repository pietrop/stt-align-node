...
describe('Deleted - word in STT is not in the base text human corrected one', () => {
  ...
  // TODO: fix this test - it should use for end time the start time of following word
  // TODO: something weird happens across some tests with the timings of the word was 
  test('Delete - First word', () => {
 
    const baseTextAccurateTranscription =
      'There a day, about 10 years ago, when I asked a friend to hold a baby dinosaur robot upside down.';
    ...
    const expectedResult = {
      words: [
           { end: 13.38, start: 13.05, text: 'There' },
                // { start: 13.21, end: 13.38, text: 'was' },
        { end: 13.44, start: 13.38, text: 'a' },
        { end: 13.86, start: 13.44, text: 'day,' },
        { end: 14.13, start: 13.86, text: 'about' },
    ...
    const result = alignJSONText(automatedSttTranscription, baseTextAccurateTranscription,  13.05);
    expect(result).toEqual(expectedResult.words);
  });
