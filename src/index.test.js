...
describe('Re-align  transcript - Deleted (dinosaur)', () => {
  test('1 deletion', () => {
    const baseTextAccurateTranscription = 'There was a day, about 10 years ago, when I asked a friend to hold a baby robot upside down. ';
    const expectedResult = {
      text: baseTextAccurateTranscription,
      words: [
        { end: 13.21, start: 13.05, text: 'There' },
        ...
        { end: 17.32, start: 17.23, text: 'a' },
        // { end: 17.63, start: 17.32, text: 'baby' },
        { end: 18.17, start: 17.32, text: 'baby' },
        // { end: 18.17, start: 17.63, text: 'dinosaur' },
        { end: 18.72, start: 18.17, text: 'robot' },
        { end: 19.17, start: 18.72, text: 'upside' },
        { end: 19.56, start: 19.17, text: 'down.' },
...
describe('Re-align  transcript - replaced (IS)', () => {
  test('1 deletion', () => {
    const baseTextAccurateTranscription = 'There IS a day, about 10 years ago, when I asked a friend to hold a baby dinosaur robot upside down. ';
    const expectedResult = {
      text: baseTextAccurateTranscription,
      words: [
        { end: 13.21, start: 13.05, text: 'There' },
        // { end: 13.325, start: 13.215, text: 'was' },
        { end: 13.38, start: 13.21, text: 'IS' },
        { end: 13.44, start: 13.38, text: 'a' },
        { end: 13.86, start: 13.44, text: 'day,' },
        { end: 14.13, start: 13.86, text: 'about' },
        { end: 14.37, start: 14.13, text: '10' },
...
describe('Re-align  transcript - Inserted (HELLO)', () => {
  test('1 deletion', () => {
    const baseTextAccurateTranscription =
      'There was a day, about 10 years HELLO ago, when I asked a friend to hold a baby dinosaur robot upside down. ';
    const expectedResult = {
      text: baseTextAccurateTranscription,
      words: [
        { end: 13.21, start: 13.05, text: 'There' },
        ...
        { end: 14.37, start: 14.13, text: '10' },
        { end: 14.61, start: 14.37, text: 'years' },
        { end: 15.024999999999999, start: 14.61, text: 'HELLO' },
        { end: 15.44, start: 15.024999999999999, text: 'ago,' },
        // { end: 15.44, start: 14.61, text: 'ago,' },
        { end: 15.67, start: 15.44, text: 'when' },
        { end: 15.82, start: 15.67, text: 'I' },
        { end: 16.19, start: 15.82, text: 'asked' },
